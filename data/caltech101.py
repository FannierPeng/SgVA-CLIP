...
# split_path = os.path.join(_IMAGE_DATASET_DIR, "split_zhou_Caltech101.json")
# image_dir = os.path.join(_IMAGE_DATASET_DIR, "101_ObjectCategories")
...
class Caltech101(data.Dataset):
    ...
    def __init__(self, phase='train', do_not_use_random_transf=False, subsample='all', num_shots=1):
        ...
        self.phase = phase
        self.name = 'Caltech_' + phase
        self.image_dir = os.path.join(_IMAGE_DATASET_DIR, "101_ObjectCategories")
        self.split_path = os.path.join(_IMAGE_DATASET_DIR, "split_zhou_Caltech101.json")
...
#         print('max_possible_nKnovel',max_possible_nKnovel)
