...
OLD_IMAGE_DATASET_DIR = '/userhome/CLIP/data/dtd/'
_IMAGE_DATASET_DIR = ''
...
class DescribableTextures(data.Dataset):
    def __init__(self, phase='train', do_not_use_random_transf=False, subsample='all', num_shots=1):
        ...
        self.split_path = os.path.join(_IMAGE_DATASET_DIR, "split_zhou_DescribableTextures.json")
