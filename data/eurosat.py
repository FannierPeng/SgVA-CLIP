...
OLD_IMAGE_DATASET_DIR = '/userhome/CLIP/data/eurosat/'
_IMAGE_DATASET_DIR = ''
...
# split_path = os.path.join(_IMAGE_DATASET_DIR, "split_zhou_EuroSAT.json")
...
class EuroSAT(data.Dataset):
    def __init__(self, phase='train', do_not_use_random_transf=False, subsample='all', num_shots=1):
        ...
        self.phase = phase
        self.name = 'EuroSAT_' + phase
        self.image_dir = os.path.join(_IMAGE_DATASET_DIR, "images")
        self.split_path = os.path.join(_IMAGE_DATASET_DIR, "split_zhou_EuroSAT.json")
