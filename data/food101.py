...
OLD_IMAGENET_DATASET_DIR = '/userhome/CLIP/data/food-101/'
...
class Food101(data.Dataset):
    def __init__(self, phase='train', do_not_use_random_transf=False, subsample='all', num_shots=1):
        ...
        self.phase = phase
        self.name = 'Food101_' + phase
        self.image_dir = os.path.join(_IMAGENET_DATASET_DIR, "images")
        self.split_path = os.path.join(_IMAGENET_DATASET_DIR, "split_zhou_Food101.json")
...
#             print('Loading Food101 dataset - phase {0}'.format(phase))
