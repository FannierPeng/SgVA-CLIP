...
_MINI_IMAGENET_DATASET_DIR = '/userhome/CLIP/data/MiniImagenet'
...
class MiniImageNetPP(data.Dataset):
    def __init__(self, phase='train', do_not_use_random_transf=False, use_base=True):
...
class FewShotDataloader():
    ...
    def createExamplesTensorData(self, examples):
        ...
        real_labels = torch.tensor([self.dataset[img_idx][1] for img_idx, _ in examples])
