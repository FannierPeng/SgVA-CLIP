...
OLD_IMAGE_DATASET_DIR = '/userhome/CLIP/data/oxford_pets/'
_IMAGE_DATASET_DIR = ''
...
# split_path = os.path.join(_IMAGE_DATASET_DIR, "split_zhou_OxfordPets.json")
# image_dir = os.path.join(_IMAGE_DATASET_DIR, "images")
...
class OxfordPets(data.Dataset):
    def __init__(self, phase='train', do_not_use_random_transf=False, subsample='all', num_shots=1):
        ...
        self.phase = phase
        self.name = 'OxfordPets_' + phase
        self.image_dir = os.path.join(_IMAGE_DATASET_DIR, "images")
        self.anno_dir = os.path.join(_IMAGE_DATASET_DIR, "annotations")
        self.split_path = os.path.join(_IMAGE_DATASET_DIR, "split_zhou_OxfordPets.json")
