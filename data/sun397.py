...
class SUN397(data.Dataset):
    def __init__(self, phase='train', do_not_use_random_transf=False, subsample='all', num_shots=1):
        ...
        self.phase = phase
        self.name = 'SUN397_' + phase
        self.image_dir = os.path.join(_IMAGE_DATASET_DIR, "SUN397")
        self.split_path = os.path.join(_IMAGE_DATASET_DIR, "split_zhou_SUN397.json")
        ...
        if os.path.exists(self.split_path):
            ...
            classnames = []
            with open(os.path.join(_IMAGE_DATASET_DIR, "ClassName.txt"), "r") as f:
                lines = f.readlines()
                for line in lines:
            ...
            # print('cname2lab:', cname2lab)
            trainval = self.read_data(self, cname2lab, "Training_01.txt")
            test = self.read_data(self, cname2lab, "Testing_01.txt")
...
#             print('Loading SUN397 dataset - phase {0}'.format(phase))
