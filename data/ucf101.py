...
OLD_IMAGE_DATASET_DIR = '/userhome/CLIP/data/ucf101/'
_IMAGE_DATASET_DIR = ''
...
# split_path = os.path.join(_IMAGE_DATASET_DIR, "split_zhou_UCF101.json")
# image_dir = os.path.join(_IMAGE_DATASET_DIR, "UCF-101-midframes")
# train, val, test = read_split(split_path, image_dir)
# classnames = [item.classname for item in train]
# # print(classnames)
# new_li=list(set(classnames))
# new_li.sort(key=classnames.index)
# print(new_li)
...
class UCF101(data.Dataset):
    ...
    def __init__(self, phase='train', do_not_use_random_transf=False, subsample='all', num_shots=1):
        ...
        self.image_dir = os.path.join(_IMAGE_DATASET_DIR, "UCF-101-midframes")
        self.split_path = os.path.join(_IMAGE_DATASET_DIR, "split_zhou_UCF101.json")
        ...
        if os.path.exists(self.split_path):
            if not os.path.exists(preprocessed):
                ...
                test = read_split(self.split_path, self.image_dir, self.phase)
        else:
            cname2lab = {}
            filepath = os.path.join(_IMAGE_DATASET_DIR, "ucfTrainTestlist/classInd.txt")
    ...
    def read_data(self, cname2lab, text_file):
        text_file = os.path.join(_IMAGE_DATASET_DIR, text_file)
        items = []
