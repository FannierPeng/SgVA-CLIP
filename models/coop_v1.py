...
class PromptLearner(nn.Module):
    ...
    def forward(self, class_ids):
        ...
        episode_tokenized_prompts = torch.cat([self.tokenized_prompts[i, :] for i in class_ids])
...
class CustomCLIP(nn.Module):
    ...
    def forward(self, image, class_ids=None):
        with torch.no_grad():
        ...
        if class_ids == None:
            ...
            return image_features, logit_scale, prompt_features

        # for i in range(len(class_ids)):
        #     save_image_tensor(image[i,:,:,:].unsqueeze(dim=0), '/userhome/fewshot/Proto_prompt/experiments/my_meta_prompt_resnet50_mini/{}.jpg'.format(i))
        ...
        return image_features, episode_text_features, logit_scale, prompt_features
